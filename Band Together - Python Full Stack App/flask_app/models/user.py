    ...
    def get_bands(cls, data):
        ...
        for a_band in list_of_bands: 
            band_data = {
                ...
                "created_at" : a_band["bands.created_at"],
                "updated_at" : a_band["bands.updated_at"]
            }
            # var_name = model_file_name.class_name(data_for_init)
            band_instance = band.Band(band_data)
            # add this to the list  
            list.bands.append(band_instance)
